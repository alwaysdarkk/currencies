...
public class MessagesConfig {
    public static final Message ONLY_PLAYER = Message.translation("commands.errors.currency.only-player").color(Color.RED);
    public static final Message PLAYER_NOT_FOUND = Message.translation("commands.errors.currency.player-not-found").color(Color.RED);
    public static final Message INVALID_AMOUNT = Message.translation("commands.errors.currency.invalid-amount").color(Color.RED);
    public static final Message PAY_DISABLE = Message.translation("commands.errors.currency.pay-disable").color(Color.RED);
    public static final Message SAME_PLAYER = Message.translation("commands.errors.currency.same-player").color(Color.RED);
