...
public class CurrencyAddSubCommand extends AbstractAsyncCommand {
    ...
    public CurrencyAddSubCommand(@Nonnull Currency currency, @Nonnull CurrencyUserCache userCache) {
        super("add", "Add balance for a player");
        ...
        this.requirePermission("currencies.commands.add");
    }
